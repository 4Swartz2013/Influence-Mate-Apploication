/*
  # Comprehensive Schema Fix for Influence Mate Platform
...
-- Create or ensure contacts table exists
...
-- Create or ensure comments table exists
...
-- Create or ensure transcripts table exists
...
-- Create or ensure ai_insights table exists
...
-- Create or ensure campaigns table exists (this is the main issue)
...
CREATE INDEX IF NOT EXISTS comments_platform_idx ON comments(platform);
...
CREATE INDEX IF NOT EXISTS ai_insights_insight_type_idx ON ai_insights(insight_type);
