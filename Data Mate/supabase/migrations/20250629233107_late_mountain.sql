/*
  # Fix Database Schema - Ensure all required tables and columns exist
  ...
  1. Schema Fixes
    ...
    - Add proper indexes, RLS policies, and triggers
...
-- Ensure campaigns table exists (this is the critical missing table)
